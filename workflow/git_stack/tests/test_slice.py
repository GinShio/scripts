...
class TestSliceAlgorithms(unittest.TestCase):
    ...
    def test_apply_slice_one_commit_per_branch(self):
        ...
        with patch("git_stack.src.slice.get_stack_commits") as mock_get_commits:
            ...
            self.mock_run_git.assert_any_call(["branch", "-f", "branch-1", "C1"])
            self.mock_run_git.assert_any_call(["branch", "-f", "branch-2", "C2"])
    ...
    def test_apply_slice_skip_commits(self):
        ...
        with patch("git_stack.src.slice.get_stack_commits") as mock_get_commits:
            ...
            self.assertEqual(node_main.children[0].name, "branch-1")
            # B1 should have B2
            self.assertEqual(node_main.children[0].children[0].name, "branch-2")
    ...
    def test_apply_slice_reparenting_insert(self):
        ...
        with patch("git_stack.src.slice.get_stack_commits") as mock_commits:
            mock_commits.return_value = [("hashA", "Armor"), ("hashB", "Feather")]

            mapping = {"hashA": "armor", "hashB": "feather"}
    ...
    def test_apply_slice_fork_modification(self):
        ...
        with patch("git_stack.src.slice.get_stack_commits") as mock_commits:
            ...
            mock_commits.return_value = [("hashXA", "NewMsgA"), ("hashC", "MsgC")]
...
class TestSliceCleanup(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_write_machete = patch("git_stack.src.slice.write_machete").start()
        self.mock_parse_machete = patch("git_stack.src.slice.parse_machete").start()
        self.mock_get_commits = patch("git_stack.src.slice.get_stack_commits").start()
    ...
    def test_cleanup_orphaned_branches(self):
        ...
        self.mock_run_git.assert_any_call(["branch", "-f", "new-branch-1", "C1"])
    ...
    def test_no_cleanup_if_kept(self):
        ...
        self.mock_refs.return_value = {"main": "C0", "existing-branch": "C1"}
