...
class TestGitApi(unittest.TestCase):
    ...
    def test_init_repository(self):
        api = GitRepository.init_repository(
            self.path, origin_url="https://example.com/repo.git"
        )
    ...
    def test_basic_status(self):
        ...
        self.assertEqual(
            api.get_current_branch(), "master"
        )  # default is usually master or main depending on git config, pygit2 default is master usually
