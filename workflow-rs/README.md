...
| [`wf project`](docs/project.md) | Describe/validate source projects from one declarative registry; `wf build` and `wf update` build and refresh them (cmake/meson/cargo) |
